const blockList = document.querySelectorAll(".tab-content ");
...
// $(".tab-content").children($(".close-btn")).click(function() {
...
function onResize() {
    $('.wrapper').height();
    const newWrapperHeigth = window.innerHeight - 2 * $("footer").height() - $("header").height();
